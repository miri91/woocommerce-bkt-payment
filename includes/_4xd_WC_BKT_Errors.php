...
class _4xd_WC_BKT_Errors
{
    public static function transaction_response_codes($code = false)
    {
        $response_codes = array(
            '01' => _('Card holders can receive detailed information by calling the bank', '4xd'),
            '02' => _('Card holders can receive detailed information by calling the bank', '4xd'),
        );

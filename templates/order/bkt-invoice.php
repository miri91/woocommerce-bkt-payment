...
<table>
	...
	<tbody class="invoice-heading">
		...
		<?php if($support_email || $support_number) { ?> <tr>
			<td><?php _e( 'Support', 'woocommerce-bkt' ); ?>: 
			    <?php 
			    if($support_email) { 
			        $backSlash = true; 
			        echo $support_email;
			    } 
			    if($support_number && $backSlash) {
	                echo ' / ';
			    } 
			    echo $support_number; 
			    ?></td>
		...
		<tr>
			<td><?php _e( 'Website', 'woocommerce-bkt' ); ?>: <?php echo site_url(); ?></td>
		</tr>
		<tr>
	...
	<?php foreach ( $line_items as $item_id => $item ): $product = $item->get_product(); ?>
		<tr>
			<td>
				<?php
				echo '<span>'.$item->get_name() . '</span><br/>'; 
	...
	<tbody>		
		...
		<tr>
			...
			<table class="has-borders">				
				...
				<tr>
					<td><?php _e( 'Transaction Type', 'woocommerce-bkt' ) ?>:</td>
					<td><?php echo $_bkt_transaction_type; ?></td>
				</tr>
				<tr>
					<td><?php _e( 'Authorization Code', 'woocommerce-bkt' ) ?>:</td>
					<td><?php echo $_bkt_transaction_auth_id; ?></td>
				</tr>
				<tr>
